...
import com.mozhimen.opencvk.databinding.ActivityDemoBinding
...
class DemoActivity : BaseActivityVB<ActivityDemoBinding>() {
    ...
    private fun cropSameSize(bitmap1: Bitmap, bitmap2: Bitmap): Pair<Bitmap, Bitmap> {
        ...
        return UtilKBitmapDeal.cropBitmap(bitmap1, minWidth, minHeight, bitmap1XY.first, bitmap1XY.second) to
                UtilKBitmapDeal.cropBitmap(bitmap2, minWidth, minHeight, bitmap2XY.first, bitmap2XY.second)
    }
}